...
import { ERR } from '../messages/role-grant-create'
import { assertBotCanPost, assertModal, assertRole, assertRoleManageable, assertTextChannel, getModalCustomId } from '../validators/role-grant-create'
import { EVENT_EMBED_ID } from './role-grant-create-button'
...
export default {
    ...
    async exec(_, interaction: Interaction) {
        ...
        try {
            ...
            if (err instanceof EmbedRoleGrantModalError)
